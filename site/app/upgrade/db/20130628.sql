...
ALTER TABLE `[#DB_PREFIX#]users` CHANGE `invite_count` `invite_count` INT( 10 ) NOT NULL DEFAULT '0' COMMENT '邀请我回复数量';
ALTER TABLE `[#DB_PREFIX#]users` CHANGE `question_count` `question_count` INT( 10 ) NOT NULL DEFAULT '0' COMMENT '主题数量';
ALTER TABLE `[#DB_PREFIX#]users` CHANGE `answer_count` `answer_count` INT( 10 ) NOT NULL DEFAULT '0' COMMENT '回复数量';
...
ALTER TABLE `[#DB_PREFIX#]users` CHANGE `thanks_count` `thanks_count` INT( 10 ) NULL DEFAULT '0' COMMENT '喜爱数量';
