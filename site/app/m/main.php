...
class main extends AWS_CONTROLLER
{
	...
	{
		$this->crumb(AWS_APP::lang()->_t('我关注的主题'), '/m/focus/');
	...
	{
		$this->crumb(AWS_APP::lang()->_t('邀请我回复的主题'), '/m/invite/');
	...
	{
		$this->crumb(AWS_APP::lang()->_t('附近的主题'), '/m/nearby_question/');
		...
		if ($weixin_user = $this->model('openid_weixin_weixin')->get_user_info_by_uid($this->user_id))
		{
			...
			{
				H::redirect_msg(AWS_APP::lang()->_t('你的附近暂时没有主题'));
			}
		}
		else
		{
