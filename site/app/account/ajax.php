...
class ajax extends AWS_CONTROLLER
{
	...
	public function register_process_action()
	{
		...
		//检查邀请码
		$the_weixin_register_invitcode = '123';//邀请码内容
		if (trim($_POST['the_weixin_register_invitcode']) == '' || $_POST['the_weixin_register_invitcode'] != $the_weixin_register_invitcode)
		{
			H::ajax_json_output(AWS_APP::RSM(null, -1, AWS_APP::lang()->_t('抱歉，你尚未输入邀请码或邀请码不正确')));	
		}
