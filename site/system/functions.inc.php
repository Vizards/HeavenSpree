<?php
/**
 * HeavenSpree Framework
 *
 * An open source application development framework for PHP 5.2.2 or newer
 *
 * @package		HeavenSpree Framework
 * @author		HeavenSpree Dev Team
 * @copyright	Copyright (c) 2011 - 2014, HeavenSpree, Inc.
 * @license		http://www.HeavenSpree.com/license/
 * @link		http://www.HeavenSpree.com/
 * @since		Version 1.0
 * @filesource
 */
...
function show_error($exception_message, $error_message = '')
{
	...
	{
		AWS_APP::mail()->send('HeavenSpree_report@outlook.com', '[' . G_VERSION . '][' . G_VERSION_BUILD . '][' . base_url() . ']' . $error_message, nl2br($exception_message), get_setting('site_name'), 'HeavenSpree');
	}
