...
$config['QUESTION_INVITE'] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 上邀请您回复主题: [#question_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 上邀请您回复主题: [#question_title#]",
);
...
$config['NEW_ANSWER'] = array(
	'subject' => "您在 [#site_name#] 上关注的主题有了新的回复: [#question_title#]",
	'message' => "您在 [#site_name#] 上关注的主题有了新的回复: [#question_title#]",
);
...
$config['INVITE_QUESTION'] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 上邀请您参与主题 [#question_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 上邀请您参与主题 [#question_title#]",
	'link_title' => "[#question_title#]",
);

$config['QUESTION_SHARE'] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 给你分享了一个主题: [#question_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 给你分享了一个主题: [#question_title#]",
);

$config['ANSWER_SHARE'] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 给你分享了一个主题: [#question_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 给你分享了一个主题: [#question_title#] [#answer_user#]：[#answer_content#]",
);
...
$config['QUESTION_MOD'] = array(
	'subject' => "[#user_name#] 在 [#site_name#] 修改了你发布的主题: [#question_title#]",
	'message' => "[#user_name#] 在 [#site_name#] 修改了你发布的主题: [#question_title#]",
);

$config['QUESTION_DEL'] = array(
	'subject' => "您在 [#site_name#] 上发表的主题 [#question_title#] 已被管理员删除",
	'message' => "您发表的主题 [#question_title#] 已被管理员删除<br /><br />----- 所删除的内容 -----<br /><br />[#question_detail#]<br /><br />-----------------------------<br /><br />如有疑问, 请联系管理员",
);
