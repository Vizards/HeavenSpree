...
) ENGINE=[#DB_ENGINE#] DEFAULT CHARSET=utf8 COMMENT='回复';
...
) ENGINE=MYISAM DEFAULT CHARSET=utf8 COMMENT='主题列表';
...
) ENGINE=[#DB_ENGINE#] DEFAULT CHARSET=utf8 COMMENT='主题关注表';
...
CREATE TABLE `[#DB_PREFIX#]question_invite` (
  ...
  KEY `add_time` (`add_time`)
) ENGINE=[#DB_ENGINE#] DEFAULT CHARSET=utf8 COMMENT='邀请主题';
...
CREATE TABLE `[#DB_PREFIX#]question_uninterested` (
  ...
  KEY `uid` (`uid`)
) ENGINE=[#DB_ENGINE#] DEFAULT CHARSET=utf8 COMMENT='主题不感兴趣表';
