...
('site_name', 's:8:"HeavenSpree";'),
('description', 's:30:"HeavenSpree 社交化知识社区";'),
('keywords', 's:47:"HeavenSpree,知识社区,社交社区,主题社区";'),
('sensitive_words', 's:0:"";'),
...
('reputation_function', 's:78:"[最佳答案]*3+[赞同]*1-[反对]*1+[发表者赞同]*2-[发表者反对]*1";'),
