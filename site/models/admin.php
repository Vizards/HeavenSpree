    ...
    public function get_notifications_texts()
    {
        ...
        if ($notifications['question_approval'])
        {
            $notifications_texts[] = array(
                                            ...
                                            'text' => AWS_APP::lang()->_t('有 %s 个主题待审核', $notifications['question_approval'])
                                        );
        }
        ...
        if ($notifications['unverified_modify_count'])
        {
            $notifications_texts[] = array(
                                            ...
                                            'text' => AWS_APP::lang()->_t('有 %s 个主题修改待审核', $notifications['unverified_modify_count'])
                                        );
        }
        ...
        {
            $notifications_texts[] = array(
                                            'url' => 'http://www.HeavenSpree.com/downloads/',
